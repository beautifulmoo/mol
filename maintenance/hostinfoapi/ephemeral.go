...
func StartEphemeralDiscovery(cfg *agentcfg.Config, displayVersion string, srcPort int) (*discovery.Discovery, func(), error) {
...
func discoveryBroadcastAddrs(cfg *agentcfg.Config) []string {
...
func effectiveMaintenancePort(cfg *agentcfg.Config) int {

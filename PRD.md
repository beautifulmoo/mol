...
| 경로 | 역할 |
|------|------|
| **`maintenance/maintenance.go`** | `Run` — 서비스(`-cfg`)·`agent` CLI 분기, embed `web/*`; **`RegisterMaintenanceProxy`** 는 `maintenance/ginproxy` 로 브리지 |
